#############################################################################
# Script name:	check_veeam_agent_eventlogs.ps1
# Version: 	2.1
# Edit on: 	16/11/2018
# Author: 	RPR
# Purpose: 	Check Veeam Agent Backup success or failure via event logs
# Note: 	does NOT use PowerShell plug-in 
# Note : 	V2.1 : Ajustement ligne 52 : if ($LogEntry.Message.ToString() -like "*Veeam Agent*") pour être compatible V5 Veeam Agent
#############################################################################
